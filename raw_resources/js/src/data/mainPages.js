...
import { VideoDetail, VideoList, SideVideoList } from "../components/common";
...
export default (contentArray, pageId, contentId, loadMoreResultsAction, setTitleAction) => {
    let pages = {
        ...
        "side-video-list": {
            component: <SideVideoList contentId={contentId} loadMoreAction={loadMoreResultsAction} contentArray={contentArray} />
        }
    };
    return pages[pageId];
};
